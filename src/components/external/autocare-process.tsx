  ...
  return (
    <section className="section-animate bg-[#202020] py-[135px] pb-[140px] max-[700px]:py-[78px]">
      <Container>
        ...
        <div className="mt-[92px] grid grid-cols-6 gap-x-[110px] gap-y-[70px] text-center max-[1050px]:grid-cols-1 max-[1050px]:gap-[50px]">
          {process.map((item, index) => {
            const Icon = item.icon;
            return (
              <article
                className={[
                  "relative col-span-2 max-[1050px]:col-span-1",
                  index === 3 ? "col-start-2 max-[1050px]:col-start-auto" : "",
                  index === 4 ? "col-start-4 max-[1050px]:col-start-auto" : "",
                ].join(" ")}
                key={item.title}
              >
